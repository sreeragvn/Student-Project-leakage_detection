...
def main():
    ...
    # model_json = model.to_json()
    # with open("AgeGroupOmitBigCities/TotallogRelative.json", "w") as json_file:
    #     json_file.write(model_json)
    # # serialize weights to HDF5
    # model.save_weights("AgeGroupOmitBigCities/TotalLogRelative.h5")    
    ...
    for i in range(0,df.shape[0]):
        ...
        ax.legend()           
        filename='OmitBigCities/plotlognormal/'+str(int(df['west(0)/east(1)'].iloc[i]))+df['Landkreis'].iloc[i]+'.png'
