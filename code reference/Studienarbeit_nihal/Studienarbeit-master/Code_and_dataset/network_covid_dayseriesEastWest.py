...
def main():
    ...
    target = dfE[['RelativeLogDailycases','west(0)/east(1)']]
    ...
    testtarget=dfW[['RelativeLogDailycases','west(0)/east(1)']]
    ...
    for i in range(0,dfW.shape[0]/lastday):
        ...
        ax.legend()
        filename='AgeGroupOmitBigCities/plotlogEastWestRelative/'+dfW['Landkreis'].iloc[i*lastday]+'.png'        
