...
def main():
    ...
    features = dfW[['Density','Income','Einwohner(35-79)','firstday','Day']]
    ...
    testfeatures =  dfE[['Density','Income','Einwohner(35-79)','firstday','Day']]
    testfeatures = testfeatures.values
    testEinwohner=dfE['LK_Einwohner']
    ...
    json_file = open('AgeGroupOmitBigCities/WestLog.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    model = keras.models.model_from_json(loaded_model_json)
    # load weights into new model
    model.load_weights("AgeGroupOmitBigCities/WestLog.h5")
    ...
    for i in range(0,dfE.shape[0]/lastday):
        ...
        ax.legend()   
        filename='AgeGroupOmitBigCities/plotlogWestEastNormal/'+dfE['Landkreis'].iloc[i*lastday]+'.png'
